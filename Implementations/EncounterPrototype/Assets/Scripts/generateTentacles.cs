...
public class JellyfishTentacles : MonoBehaviour
{
    ...
    private Vector3[][] tentaclePositions;
    ...
    void GenerateTentacles()
    {
        ...
        tentaclePositions = new Vector3[tentacleCount][];
        ...
        for (int i = 0; i < tentacleCount; i++)
        {
            ...
            tentacles[i] = lr;
            tentaclePositions[i] = new Vector3[tentacleSegments];
        }
    }
    ...
    void UpdateTentaclePositions()
    {
        ...
        for (int tentacleIndex = 0; tentacleIndex < tentacleCount; tentacleIndex++)
        {
            ...
            for (int segmentIndex = 0; segmentIndex < tentacleSegments; segmentIndex++)
            {
                ...
                // - Rhythmic swaying
                // - Organic noise
                tentaclePositions[tentacleIndex][segmentIndex] = new Vector3(
            ...
            tentacles[tentacleIndex].SetPositions(tentaclePositions[tentacleIndex]);
        }
    }
    ...
    void OnValidate()
    {
        ...
        if (Application.isPlaying && tentacles != null && tentacles.Length != tentacleCount)
        {
            ...
            {
                if (tentacles[i] != null)
                    DestroyImmediate(tentacles[i].gameObject);
            }
